...
function CreateMessage() {
    return (
        <div className=" flex flex-row p-2 border-gray-500 bg-gray-500 rounded-lg">
            <input type="text" className=" w-full text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-100 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Enter your Message..." required />
